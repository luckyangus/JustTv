...
<div align="center">
  <img src="public/logo.png" alt="JustTv Logo" width="120">
</div>

> 🎬 **JustTv** 是一个开箱即用的、跨平台的影视聚合播放器。它基于 **Next.js 14** + **Tailwind&nbsp;CSS** + **TypeScript** 构建，支持多资源搜索、在线播放、收藏同步、播放记录、云端存储，让你可以随时随地畅享海量免费影视内容。
...
JustTv 支持标准的苹果 CMS V10 API 格式。

## 订阅

将完整的配置文件 base58 编码后提供 http 服务即为订阅链接，可在 JustTv 后台/Helios 中使用。
...
| NEXT_PUBLIC_SITE_NAME               | 站点名称                 | 任意字符串               | JustTv                                                                                                                     |
...
[MIT](LICENSE) © 2025 JustTv & Contributors
